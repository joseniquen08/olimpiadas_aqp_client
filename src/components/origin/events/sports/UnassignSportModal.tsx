...
export function UnassignSportModal({ sport_event_id, name }: Props) {
  ...
  const onSubmit = async () => {
    ...
    const response = await fetch(`/api/event/unassign/sport`, {
      method: 'DELETE',
      body: JSON.stringify({
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title as="h3" className="text-xl font-bold leading-6 text-emerald-900">Desasignar deporte del evento</Dialog.Title>
